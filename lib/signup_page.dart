...
class SignupPage extends StatefulWidget {
  @override
  _SignupPageState createState() => _SignupPageState(); // ✅ Correct
}
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                await saveProfileData(); // 🟢 First, save the profile data
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => HomePage()), // 🟢 Then navigate to HomePage
                );
              },
